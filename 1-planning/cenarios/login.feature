Feature: Login
  ...
  Scenario Outline: Validar login  pelo Menu
    ...
    Examples:
      ...
      | https://www.tudocelular.com/compare/ | icLogin | userName | password | Log in | andreson.moura@outlook.com | T4yna4raTest | Log in realizado com sucesso |
      | https://www.tudocelular.com/compare/ | icLogin | userName | password | Log in | andreson.moura@outlook.com | T4yna4raTest | Log in realizado com sucesso |
      | https://www.tudocelular.com/compare/ | icLogin | userName | password | Log in | Andreson Moura             | T4yna4raTest | Log in realizado com sucesso |
      | https://www.tudocelular.com/compare/ | icLogin | userName | password | Log in | Andreson Moura             | T4yna4raTest | Log in realizado com sucesso |
  ...
  Scenario Outline: Validar que o Login não seja realizado com sucesso com UserName ou Email inválidos pela página Register e Forum
    ...
    Examples:
      ...
      | https://www.tudocelular.com/compare/ | https://www.tudocelular.com/forum/register.php | userName | password | Log in | andreson.moura@outlook.com | 1234         | Dados inválidos |
      | https://www.tudocelular.com/compare/ | https://www.tudocelular.com/forum/register.php | userName | password | Log in | Andreson Moura             | *            | Dados inválidos |
      | https://www.tudocelular.com/compare/ | https://www.tudocelular.com/forum/register.php | userName | password | Log in | andreson.moura@outlook.com |              | Dados inválidos |
  ...
  Scenario Outline: Validar que o Login não seja realizado com sucesso com UserName ou Email inválidos pelo Menu
    ...
    Examples:
      ...
      | https://www.tudocelular.com/forum/register.php | userName | password | Log in | andreson.moura@outlook.com | 1234         | Dados inválidos |
      | https://www.tudocelular.com/forum/register.php | userName | password | Log in | Andreson Moura             | *            | Dados inválidos |
      | https://www.tudocelular.com/forum/register.php | userName | password | Log in | andreson.moura@outlook.com |              | Dados inválidos |
